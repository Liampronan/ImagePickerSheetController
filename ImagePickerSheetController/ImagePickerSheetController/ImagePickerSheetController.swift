...
public class ImagePickerSheetController: UIViewController {
    ...
    private(set) lazy var previewCollectionView: PreviewCollectionView = {
        ...
        collectionView.register(PreviewSupplementaryView.self, forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: String(describing: PreviewSupplementaryView.self))
    ...
    private func initialize() {
        ...
        NotificationCenter.default.addObserver(sheetController, selector: #selector(SheetController.handleCancelAction), name: Notification.Name.UIApplicationDidEnterBackground, object: nil)
    }

    deinit {
        NotificationCenter.default.removeObserver(sheetController, name: Notification.Name.UIApplicationDidEnterBackground, object: nil)
    }
    ...
    private func fetchAssets() {
        ...
        result.enumerateObjects { (asset: PHAsset, _, stop: UnsafeMutablePointer<ObjCBool>) in
            defer {
    ...
    private func requestImageForAsset(_ asset: PHAsset, completion: @escaping (_ image: UIImage?) -> ()) {
    ...
    func enlargePreviewsByCentering(to indexPath: IndexPath?, completion: ((Bool) -> Void)?) {
...
extension ImagePickerSheetController: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: String(describing: PreviewCollectionViewCell.self), for: indexPath) as! PreviewCollectionViewCell
    ...
    public func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let view = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionElementKindSectionHeader, withReuseIdentifier: String(describing: PreviewSupplementaryView.self), for: indexPath) as! PreviewSupplementaryView
...
extension ImagePickerSheetController: UICollectionViewDelegate {
    ...
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if !enlargedPreviews {
            enlargePreviewsByCentering(to: indexPath) { _ in
